...
var displayMap = function displayMap(location) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibXJyYWgiLCJhIjoiY2thZ2wxemkyMDNkcjJycXlwdG84a3B0NCJ9.99QRo8omf3fNE3GAXiTjbQ';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Log in sucessfully!');
...
var stripe = Stripe('pk_test_51GqOa9F8IBbCpXSkur5zc17ZZFwNDqXECux9PigEBYrlI5bVHVMVvDEyK1Awx6k4znR4Ba01OokQozcp61noUcNL00YvKaW4AI');
